package com.chayoticace.cc17_top10youtube
...
import com.example.myfavoriteyoutubechannels.handlers.VideoHandler
import com.example.myfavoriteyoutubechannels.models.YoutubeVideo
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

lateinit var youtubeVideosHandler: VideoHandler
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        youtubeVideosHandler = VideoHandler()
    ...
    override fun onStart() {
        super.onStart()
        //Applying of a  listener every time the database updates.
        youtubeVideosHandler.youtubeVideosReference.addValueEventListener(object: ValueEventListener {
            ...
            override fun onCancelled(p0: DatabaseError) {
                //TODO("Not yet implemented and never will be...")
            }
